...
nav a:hover {
 background-color: #BDF9A8;
	...
	<style>
		...
		.summary-dokter{
			background-color: #43DA0F;
			border-radius: 15px;
		}
		.summary-berobat{
			background-color: #60C23E;
			border-radius: 15px;
		}
		.summary-resep{
		...
		<nav aria-label="breadcrumb">
		  <ol class="breadcrumb">
			<li class="text-black-item active" aria-current="page">
				...
				<h2 align="center" > Data Klinik Dr.Suci</h2>
			</li>
		  </ol>
		</nav>
